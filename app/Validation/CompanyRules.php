...
class CompanyRules
{
    public static function store(?string $companyId = null): array
    {
        return [
            ...
            'company.theme' => 'nullable|array',
            'company.theme.colors' => 'nullable|array',
            'company.theme.colors.primary' => ['nullable', 'string', 'regex:/^#[0-9A-Fa-f]{6}$/'],
            'company.theme.colors.secondary' => ['nullable', 'string', 'regex:/^#[0-9A-Fa-f]{6}$/'],
