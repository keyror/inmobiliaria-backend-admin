...
use App\Services\Central\ICompanyService as ICentralCompanyService;
use App\Services\Central\IDashboardService as ICentralDashboardService;
use App\Services\Central\Implements\CompanyService as CentralCompanyService;
use App\Services\Central\Implements\DashboardService as CentralDashboardService;
use App\Services\Central\Implements\PersonService as CentralPersonService;
use App\Services\Central\Implements\PlanService as CentralPlanService;
use App\Services\Central\Implements\SiteManagementService as CentralSiteManagementService;
use App\Services\Central\Implements\TenantService as CentralTenantService;
use App\Services\Central\Implements\TenantUserService as CentralTenantUserService;
use App\Services\Central\IPersonService as ICentralPersonService;
use App\Services\Central\IPlanService as ICentralPlanService;
use App\Services\Central\ISiteManagementService as ICentralSiteManagementService;
use App\Services\Central\ITenantService as ICentralTenantService;
use App\Services\Central\ITenantUserService as ICentralTenantUserService;
...
use App\Services\Implements\DocumentSignatoryService;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this->app->bind(ICentralDashboardService::class, CentralDashboardService::class);
        $this->app->bind(ICentralSiteManagementService::class, CentralSiteManagementService::class);
        $this->app->bind(ICentralCompanyService::class, CentralCompanyService::class);
        $this->app->bind(ICentralPersonService::class, CentralPersonService::class);
        $this->app->bind(ICentralPlanService::class, CentralPlanService::class);
        $this->app->bind(ICentralTenantService::class, CentralTenantService::class);
        $this->app->bind(ICentralTenantUserService::class, CentralTenantUserService::class);
