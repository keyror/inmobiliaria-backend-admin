...
return [
    ...
    'attributes' => [
        ...
        'document_from' => 'lugar de expedición',
        'organization_type_id' => 'tipo de organización',
        'birth_date' => 'fecha de nacimiento',
        'gender' => 'género',
        'is_active' => 'estado activo',
        'fiscal_profile.tax_regime' => 'régimen fiscal',
        'fiscal_profile.responsible_for_vat' => 'responsable de IVA',
        'fiscal_profile.vat_withholding' => 'retención de IVA',
        'fiscal_profile.income_tax_withholding' => 'retención de fuente',
        'fiscal_profile.ica_withholding' => 'retención de ICA',
        'fiscal_profile.economic_activity' => 'actividad económica',
        'fiscal_profile.dv' => 'dígito de verificación',
        'fiscal_profile.taxe_type_id' => 'tipo de obligación tributaria'
    ],
];
